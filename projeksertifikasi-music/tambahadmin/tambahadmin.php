...
$users = [
  ['name' => 'Naylan Admin', 'email' => 'naylanadmin@gmail.com', 'password' => 'naylanadmin', 'role' => 'admin'],
];
...
foreach ($users as $u) {
  ...
  $stmt = mysqli_prepare($koneksi, "INSERT INTO users (name, email, password_hash, role) VALUES (?, ?, ?, ?)");
