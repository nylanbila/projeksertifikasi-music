      ...
      <div class="px-4 py-3 sm:px-6 flex items-center justify-between">
        ...
        <!-- tambah user -->
         <p class="mt-4 text-right">
            <a href="/projeksertifikasi-music/public/admin/add_user.php" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                Tambah User
            </a>
        </p>
        <!-- end -->
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <?php if ($row['id'] != $current_user_id): ?>
                    <form method="post" action="/projeksertifikasi-music/app/process_update_role.php" class="flex items-center gap-3">
