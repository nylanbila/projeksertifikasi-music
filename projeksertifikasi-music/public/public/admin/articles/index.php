  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
      ...
      <form method="GET" action="" class="flex gap-2">
        ...
        <button type="submit" class="bg-violet-700 text-white px-3 py-2 rounded text-sm hover:bg-indigo-700">Search</button>
        <?php if ($searchQuery !== ''): ?>
      ...
      <a href="create.php" class="bg-violet-700 text-white px-4 py-2 rounded text-sm hover:bg-indigo-700">Buat Artikel</a>
    </div>
                ...
                <td class="px-4 py-3 text-center align-top">
                  <div class="inline-flex items-center gap-2">
                    ...
                    <a href="edit.php?id=<?= $a['id'] ?>" class="text-indigo-600 text-sm px-2 py-1 rounded hover:bg-indigo-50">
                      <img src="https://img.icons8.com/?size=100&id=8186&format=png&color=4B86E8" 
                    ...
                    <!-- lihat berdasarkan slug (url) -->
                    <a href="<?= '../../articles.php?slug=' . e($a['slug']) ?>" target="_blank" class="text-gray-600 text-sm px-2 py-1 rounded hover:bg-gray-100">
                      <img src="https://img.icons8.com/?size=100&id=7877&format=png&color=FCC419" alt="lihat" class="w-5 h-5">
                    </a>
                  </div>
                </td>
              </tr>
