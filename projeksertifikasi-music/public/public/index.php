...
<section class="py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-6">
    <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">🌟 Featured Artists</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">

      <!-- Artist Card -->
      <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition">
        <img src="https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=500&q=60"
             alt="Artist 1"
             class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
        <h3 class="text-lg font-semibold text-gray-800 mb-1">The Weeknd</h3>
        <p class="text-sm text-gray-500 mb-2">Pop / R&B</p>
        <p class="text-gray-600 text-sm">Abel Tesfaye, dikenal sebagai The Weeknd, adalah penyanyi dan penulis lagu asal Kanada yang terkenal dengan suara falsetto khasnya.</p>
      </div>

      <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition">
        <img src="https://images.unsplash.com/photo-1507874457470-272b3c8d8ee2?auto=format&fit=crop&w=500&q=60"
             alt="Artist 2"
             class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
        <h3 class="text-lg font-semibold text-gray-800 mb-1">Dua Lipa</h3>
        <p class="text-sm text-gray-500 mb-2">Pop / Dance</p>
        <p class="text-gray-600 text-sm">Dua Lipa adalah penyanyi Inggris yang meraih ketenaran dengan hits seperti "Levitating" dan dikenal dengan gaya musik pop-dance yang energik.</p>
      </div>

      <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition">
        <img src="https://images.unsplash.com/photo-1485579149621-3123dd979885?auto=format&fit=crop&w=500&q=60"
             alt="Artist 3"
             class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
        <h3 class="text-lg font-semibold text-gray-800 mb-1">Ed Sheeran</h3>
        <p class="text-sm text-gray-500 mb-2">Pop / Acoustic</p>
        <p class="text-gray-600 text-sm">Ed Sheeran adalah penyanyi dan penulis lagu asal Inggris, terkenal dengan lagu-lagu romantis dan gaya akustik yang khas.</p>
      </div>

      <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition">
        <img src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=500&q=60"
             alt="Artist 4"
             class="w-32 h-32 mx-auto rounded-full object-cover mb-4 shadow-md">
        <h3 class="text-lg font-semibold text-gray-800 mb-1">Justin Bieber</h3>
        <p class="text-sm text-gray-500 mb-2">Pop / R&B</p>
        <p class="text-gray-600 text-sm">Penyanyi asal Kanada yang terkenal sejak remaja, Justin Bieber memiliki banyak hits global dan dikenal dengan suara pop-R&B khasnya.</p>
      </div>
